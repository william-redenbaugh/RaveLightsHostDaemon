...
mod udp_control;
use udp_control::{clock_control, heaat_control, heart_control, matrix_control, relay_control};

// Serial control files.
// Lets us control devices on the local serial interface
mod serial_control;
use serial_control::{strip_control, teensy_control};
...
mod protobuf;
use protobuf::{general_instructions, heaat_message, messagedata, relay_msg};
